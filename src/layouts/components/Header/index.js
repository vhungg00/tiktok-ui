            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('actions')}>
                    ...
                    <Menu items={currentUser ? USER_MENU : MENU_ITEMS}>
                        {currentUser ? (    
                           <img className={cx('user-avatar')} src='https://p16-sign-va.tiktokcdn.com/tos-maliva-avt-0068/235409ab36b0531ee42013689aac26be~c5_100x100.jpeg?x-expires=1655863200&x-signature=rGmsvJEe0bxoZuhC7e9ccN%2Fo9MQ%3D' />
                        ) : (
                            <button className={cx('see-more-icon')}>
                                <svg
